...
class Map extends Mapper<Object, Text, Text, IntWritable> {
	...
	static Log logger = LogFactory.getLog(Map.class);
	...
	private HashMap<String, Integer> getDictionnary()
		...
		Path pt = new Path("/home/hamza/workspace/AnalyseDesSentimes/data/dictionary.txt");
	...
	protected void map(Object key, Text value, Context context)
		...
		while (scanner.hasNext()) {
			...
			Text date = new Text(DateConverter.getMonth(creationDate));
